...
const more = [
  {
    icon: Settings,
    title: "Installation",
    desc: "Brand-new appliance installation by certified pros.",
  },
  {
    icon: Wrench,
    title: "Maintenance & AMC",
    desc: "Annual maintenance plans to keep appliances running like new.",
  },
  {
    icon: Thermometer,
    title: "Gas Refilling",
  ...
  },
  {
    icon: Sparkles,
    title: "Deep Cleaning",
    desc: "Professional AC deep cleaning for better cooling and air quality.",
  },
  {
    icon: Zap,
